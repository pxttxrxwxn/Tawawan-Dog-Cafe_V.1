        ...
        button.addEventListener("click", function () {
            ...
            if (!menuItem.dataset.editing) {
                ...
                this.addEventListener("click", function saveEdit() {
                    ...
                    let updatedBakeryCategories = JSON.parse(localStorage.getItem('bakeryCategories')) || [];
                    updatedBakeryCategories = updatedBakeryCategories.filter(menu => menu.name !== nameElement.textContent.trim());

                    updatedBakeryCategories.push({
                        imageUrl: menuItem.querySelector("img").src,
                        name: nameElement.textContent.trim(),
                        price: priceInput.value.trim()
                    });
                    localStorage.setItem('bakeryCategories', JSON.stringify(updatedBakeryCategories));
